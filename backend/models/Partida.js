...
const Partida = {
  ...
  create: async (id_usuario) => {
    try {
      ...
      // Estado inicial del juego actualizado
      const estadoInicial = {
        capitan: {
          traje: 6,
          estres: 0,
          estres_maximo: 3, // Nuevo: límite de estrés
          oxigeno: 10
        },
        pasajeros: 6,
        pasajeros_sacrificados: 0, // Nuevo: contador para logros
        armas: [
          { nombre: 'Palanca', danio: 1, precision: 1, municion: null, municion_max: null },
        ...
        mochila: [],
        items_usados: 0, // Nuevo: contador para logros
        mapa: mapa,
        adyacencias: adyacencias,
        posicion_actual: { x: 0, y: 0 },
        codigos_activacion: 0,
        puertas_abiertas: 0, // Nuevo: contador para logro "DESCIFRADOR"
        habitaciones_exploradas: [],
        eventos_completados: [],
        proxima_habitacion_encuentro: false, // Nuevo: para reacción de pasajeros
        evadir_proximo_ataque: false, // Nuevo: para sacrificio de pasajeros
        bonus_precision_temporal: 0, // Nuevo: para ítems que afectan precisión
        encuentro_actual: null,
        logros: {},
        aliens_derrotados: {}, // Nuevo: detalle de aliens derrotados para logros
        estado: 'EN_CURSO'
      };
